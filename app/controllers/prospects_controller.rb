class ProspectsController < ApplicationController
  ...
  def show
    @comments = @prospect.comments.order(created_at: :desc)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @prospect.save
        format.html { redirect_to prospect_url(@prospect), notice: "El prospecto fue creado exitosamente" }
  ...
  def update
    respond_to do |format|
      if @prospect.update(prospect_params)
        format.html { redirect_to prospect_url(@prospect), notice: "El prospecto fue actualizado exitosamente" }
  ...
  private
    ...
    def prospect_params
      params.require(:prospect).permit(:email, :name, :phone, :status, :entered_by)
    end
end
