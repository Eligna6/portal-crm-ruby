...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference("Prospect.count") do
      post prospects_url, params: { prospect: { email: @prospect.email, entered_by: @prospect.entered_by, name: @prospect.name, phone: @prospect.phone, status: @prospect.status } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { email: @prospect.email, entered_by: @prospect.entered_by, name: @prospect.name, phone: @prospect.phone, status: @prospect.status } }
